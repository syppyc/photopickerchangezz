...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public ImageGridAdapter(PhotoPickerActivity activity, Context context, boolean showCamera, int itemSize) {
        mActivity = activity;
        mContext = context;
     ...
     * @param image
     */
    public void selects(Image image) {
        if (mSelectedImages.contains(image)) {
            mSelectedImages.remove(image);
            mSelectedImages.add(0,image);
        } else {
            mSelectedImages.add(0,image);
        }
        notifyDataSetChanged();
        ...
        if (type == TYPE_CAMERA) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mActivity.SelectPhotos(i, getItem(i));
                }
            });
            view.setTag(null);
    ...
    class ViewHolde {
        ...
        void bindData(final Image data, final int position) {
            ...
            indicator.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    mActivity.SelectPhotos(position, getItem(position));
                }
            });
        }
    }
